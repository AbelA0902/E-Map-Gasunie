...
input_file_path = 'Excel storage\Wind_Data_2022_to_Today.xlsx'  # Vul hier het volledige bestandspad in
...
if df is not None:
    ...
    excel_file_name = "cleaned_data_wind.xlsx"  # Nieuwe output bestandsnaam
...
""")
        ...
        pdf_file_name = "Wind_data_quality_report.pdf"
