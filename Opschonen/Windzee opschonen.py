...
input_file_path = 'Excel storage\Windoffshore_Data_2022_to_Today.xlsx'  # Vul hier het volledige bestandspad in
...
if df is not None:
    ...
    excel_file_name = "cleaned_data_windoffshore.xlsx"  # Nieuwe output bestandsnaam
...
""")
        ...
        pdf_file_name = "Windoffshore_data_quality_report.pdf"
