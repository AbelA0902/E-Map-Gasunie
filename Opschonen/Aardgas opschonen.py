...
input_file_path = 'Excel storage\Fossilgaspower_Data_2022_to_Today.xlsx'  # Vul hier het volledige bestandspad in
...
if df is not None:
    ...
    excel_file_name = "cleaned_data_fossilgaspower.xlsx"  # Nieuwe output bestandsnaam
...
""")
        ...
        pdf_file_name = "Fossilgaspower_data_quality_report.pdf"
